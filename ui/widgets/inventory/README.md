...
- **`dialogs.py`**: Dialogs for batch creation, manual stock adjustments, details inspection, batch unpack & retail transfer (`UnpackTransferDialog`), and batch expiration alerts.
