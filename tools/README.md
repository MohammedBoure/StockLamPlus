...
- **`migrate_wholesale_retail_schema.py`** : Script d'exécution de migration de schéma idempotent pour la prise en charge du commerce de gros et détail (Locations, Batches, Invoices, Clients).
