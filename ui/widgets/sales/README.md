...
- `point_of_sale_tab.py` : Interface de caisse POS tactile optimisée pour l'espace (barre supérieure ultra-fine avec net à payer dynamique, contrôles client/date sur une ligne, panier avec bouton de suppression prioritaire en tête, colonnes commerciales au centre et colonnes Stock/Lot/TVA en fin de tableau, barre d'actions inférieure et panneau droit pour produits favoris).
